...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-0 w-0 rounded-full bg-white outline-none duration-500 disabled:pointer-events-none disabled:opacity-50 group-hover/slider:h-2 group-hover/slider:w-2" />
  </SliderPrimitive.Root>
));
